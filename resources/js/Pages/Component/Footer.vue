            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a href="https://www.instagram.com/sysifosweb_/" target="_blank" class="text-gray-400 hover:text-cyan-400 transition-colors duration-200">
                        ...
                        <a href="https://www.linkedin.com/company/sysifos-web" target="_blank" class="text-gray-400 hover:text-cyan-400 transition-colors duration-200">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li>
                            <Link href="/" class="text-gray-300 hover:text-cyan-400 transition-colors duration-200">
                                Inicio
                            </Link>
                        </li>
                        <li>
                            <Link href="/nosotros" class="text-gray-300 hover:text-cyan-400 transition-colors duration-200">
                                Nosotros
                            </Link>
                        </li>
                        <li>
                            <Link href="/servicios" class="text-gray-300 hover:text-cyan-400 transition-colors duration-200">
                                Servicios
                            </Link>
                        </li>
                        <!-- <li>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-300">
                        ...
                        <li class="flex items-start">
                            <svg class="h-5 w-5 mr-2 mt-0.5 text-cyan-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
