import { mergeProps, reactive, ref, resolveDirective, unref, withCtx, createTextVNode, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrGetDirectiveProps, ssrRenderAttr, ssrIncludeBooleanAttr, ssrLooseContain, ssrRenderClass } from 'vue/server-renderer';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(` y autorizo a Sysifos a contactarme sobre mi consulta. Puedo ejercer mis derechos de acceso, rectificaci\xF3n, cancelaci\xF3n y oposici\xF3n cuando lo desee. </span></label></div><button type="submit"${ssrIncludeBooleanAttr(isSubmitting.value) ? " disabled" : ""} class="${ssrRenderClass([isSubmitting.value ? "opacity-50 cursor-not-allowed" : "", "w-full py-4 mt-2 rounded-xl bg-white text-black font-bold text-sm hover:bg-gray-200 transition-colors flex items-center justify-center group"])}">${ssrInterpolate(isSubmitting.value ? "Enviando..." : "Comenzar colaboraci\xF3n")} `);
...
//# sourceMappingURL=contacto-B_l10oNy.mjs.map
