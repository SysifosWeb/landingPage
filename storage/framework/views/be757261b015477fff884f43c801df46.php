...
<link href="<?php echo e(asset('storage/logos/logo-simple-min.png')); ?>" rel="icon" type="image/x-icon"/>
      ...
      <div class="relative z-10 w-full max-w-2xl mx-auto">
        <div class="flex flex-col items-center gap-6 text-center">
          <div class="relative w-40 h-40 animate-float">
            <div class="absolute inset-0 rounded-full bg-cover bg-center shadow-lg" style='background-image: url("<?php echo e(asset('storage/logos/logo-simple-min.png')); ?>");'></div>
...
</html><?php /**PATH C:\Users\OsmanSmith\Desktop\PROYECTOS\landingPage\resources\views/Sinapsys.blade.php ENDPATH**/ ?>