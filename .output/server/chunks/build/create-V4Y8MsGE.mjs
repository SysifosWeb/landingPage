...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "max-w-4xl mx-auto" }, _attrs))}><div class="mb-6 flex items-center justify-between"><div><h1 class="text-2xl font-semibold text-gray-900 dark:text-white"> Nueva Categor\xEDa </h1><p class="mt-1 text-sm text-gray-300 dark:text-gray-300"> Crea una categor\xEDa para organizar el blog </p></div>`);
      ...
      _push(` Guardar Categor\xEDa </button></div></form></div></div>`);
    };
  }
};
...
//# sourceMappingURL=create-V4Y8MsGE.mjs.map
